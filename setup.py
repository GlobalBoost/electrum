...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        ...
        (os.path.join(usr_share, icons_dirname), ['electrum_bsty/gui/icons/electrum-bsty.png']),
    ]
...
setup(
    ...
    ] + [('electrum_bsty.plugins.'+pkg) for pkg in find_packages('electrum_bsty/plugins')],
    package_dir={
