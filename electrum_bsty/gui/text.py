...
from electrum_bsty.util import format_satoshis
from electrum_bsty.bitcoin import is_address, COIN, TYPE_ADDRESS
...
from electrum_bsty.interface import deserialize_server
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_bsty.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
