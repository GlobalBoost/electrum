...
from electrum_bsty.bitcoin import TYPE_ADDRESS
from electrum_bsty.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_bsty.util import PR_TYPE_ONCHAIN, PR_TYPE_LN
from electrum_bsty import bitcoin, constants
from electrum_bsty.transaction import TxOutput, Transaction, tx_from_str
from electrum_bsty.util import send_exception_to_crash_reporter, parse_URI, InvalidBitcoinURI
from electrum_bsty.util import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED, TxMinedInfo, get_request_status, pr_expiration_values
...
from electrum_bsty.lnutil import RECEIVED, SENT, PaymentFailure

from .dialogs.question import Question
from .dialogs.lightning_open_channel import LightningOpenChannelDialog

from electrum_bsty.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_bsty.gui.kivy.main_window import ElectrumWindow
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('electrum_bsty/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://electrum_bsty/gui/kivy/theming/light/lightning"
            ...
            icon = "atlas://electrum_bsty/gui/kivy/theming/light/" + TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def read_invoice(self):
        ...
        if not address:
            self.app.show_error(_('Recipient not specified.') + ' ' + _('Please scan a Globalboost address or a payment request'))
            return
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_bsty.util import create_bip21_uri
