...
source.exclude_dirs = bin, build, dist, contrib,
    ...
    electrum_bsty/gui/kivy/tools,
    electrum_bsty/gui/kivy/theming/light,
...
android.add_src = electrum_bsty/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_bsty/gui/kivy/tools/bitcoin_intent.xml
