...
from electrum_bsty.plugin import Device, hook
from electrum_bsty.keystore import Hardware_KeyStore
from electrum_bsty.transaction import Transaction, multisig_script
from electrum_bsty.wallet import Standard_Wallet, Multisig_Wallet
from electrum_bsty.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_bsty.base_wizard import ScriptTypeNotSupported
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def sign_message(self, sequence, message, password):
        ...
        try:
            ...
            # already encoded in GlobalBoost fashion, binary.
    ...
    def _encode_txin_type(txin_type):
        # Map from electrum_bsty code names to our code numbers.
...
class ColdcardPlugin(HW_PluginBase):
    ...
    def export_ms_wallet(wallet, fp, name):
        ...
        print('# Exported from electrum_bsty', file=fp)
