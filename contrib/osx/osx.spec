...
ICONS_FILE=PYPKG + '/gui/icons/electrum-bsty.icns'
...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_bsty/gui/qt/main_window.py',
              electrum+'electrum_bsty/gui/text.py',
              electrum+'electrum_bsty/util.py',
              electrum+'electrum_bsty/wallet.py',
              electrum+'electrum_bsty/simple_config.py',
              electrum+'electrum_bsty/bitcoin.py',
              electrum+'electrum_bsty/dnssec.py',
              electrum+'electrum_bsty/commands.py',
              electrum+'electrum_bsty/plugins/cosigner_pool/qt.py',
              electrum+'electrum_bsty/plugins/email_requests/qt.py',
              electrum+'electrum_bsty/plugins/trezor/qt.py',
              electrum+'electrum_bsty/plugins/safe_t/client.py',
              electrum+'electrum_bsty/plugins/safe_t/qt.py',
              electrum+'electrum_bsty/plugins/keepkey/qt.py',
              electrum+'electrum_bsty/plugins/ledger/qt.py',
              electrum+'electrum_bsty/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
